...
- [x] Task: Add Section 1.0.1 "WARM START DETECTION" after Section 1.0 in `commands/implement.md`
...
- [x] Task: Modify Section 3.0 Step 2 to use conditional context loading
  - Add warm start conditional: use `read-context --include plan,metadata` (skip spec)
  - Workflow.md still re-read (lost after ExitPlanMode context clearing)
- [x] Task: Conductor - User Manual Verification 'Phase 1' (Protocol in workflow.md)

## Phase 2: Update newTrack to pass warm start signal

- [x] Task: Modify `commands/newTrack.md` Phase B Section 2.5 to pass `--warm-start` flag

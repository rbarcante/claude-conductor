...
## [1.2.0](https://github.com/rbarcante/claude-conductor/compare/v1.1.0...v1.2.0) (2026-02-06)
...
* apply black formatting to conductor_cli.py and implement.py ([8574bb0](https://github.com/rbarcante/claude-conductor/commit/8574bb01a562eb7d9068e40b130589e93f82fcc0))
...
* **ci:** use manifest mode for release-please to sync version across files ([1e26bf9](https://github.com/rbarcante/claude-conductor/commit/1e26bf92b8ee0fdc194e0a039342eb22702290a9))
...
* Add cross-reference to dual-format standard ([6c80631](https://github.com/rbarcante/claude-conductor/commit/6c806316731fd6bac6577c33807e64a935067268))
* Add Decision Logging documentation ([3a0a204](https://github.com/rbarcante/claude-conductor/commit/3a0a204d7dc7c9ec4596e1f39c32d917e2d922bd))
* Add dual-format standard specification ([c92a2fc](https://github.com/rbarcante/claude-conductor/commit/c92a2fc0b5e9537e52496fe8cd6ed7211cc3f5ef))
* Add Pattern Reference Layer documentation ([3eb661b](https://github.com/rbarcante/claude-conductor/commit/3eb661b17b095337caadaf1a8c1f42e79085def8))
* Add Pattern Resolution Protocol to CLAUDE.md ([c4dc9cf](https://github.com/rbarcante/claude-conductor/commit/c4dc9cfc9dfd6ba625eb01b81941eb66c00978ce))
* Add Quality Intelligence documentation and test scenarios ([afa36b6](https://github.com/rbarcante/claude-conductor/commit/afa36b6d54bf9563af256a9a38d2925af7fa270d))
* Add skill ecosystem documentation ([d586c4f](https://github.com/rbarcante/claude-conductor/commit/d586c4fc20b68b3932787957bccb4cd6c44fce51))
* Add Technology Intelligence documentation to README ([fef93e5](https://github.com/rbarcante/claude-conductor/commit/fef93e5674e29bd7041f24d6214f679bec34f281))
* Add version badge to README ([ad4cde6](https://github.com/rbarcante/claude-conductor/commit/ad4cde6c0b19f4d058d78b5332825e990ab21812))
...
* **conductor:** Add AI template documentation and test scenarios ([8aba7ef](https://github.com/rbarcante/claude-conductor/commit/8aba7ef1668d5770bd56f5437abda20c19823a6e))
* **conductor:** Add Skill Loading Protocol to CLAUDE.md ([d0db01c](https://github.com/rbarcante/claude-conductor/commit/d0db01c0581b674729f0deb99712b3976b88e222))
* **conductor:** Synchronize docs for track 'AI-Optimized Templates' ([f6a73a9](https://github.com/rbarcante/claude-conductor/commit/f6a73a96acfc502c5ab1e7989fdd5533047e8c19))
* **conductor:** Synchronize docs for track 'Decision Logging' ([7c7b267](https://github.com/rbarcante/claude-conductor/commit/7c7b26779c9088ab4dbc033d3f4914f28770291d))
* **conductor:** Synchronize docs for track 'Pattern Reference Layer' ([0a355ec](https://github.com/rbarcante/claude-conductor/commit/0a355ec52691df27726d438f5684aadff7cdf957))
* **conductor:** Synchronize docs for track 'Skill Ecosystem' ([7911b10](https://github.com/rbarcante/claude-conductor/commit/7911b1070fc56d69f9a4af8cde4fe35f08a6d469))
* **conductor:** Synchronize docs for track 'Tech Intelligence' ([a37c817](https://github.com/rbarcante/claude-conductor/commit/a37c817d05e181b2d0d5ac68639dc85b5fe86c6f))
* **implement:** Add example scenarios for git isolation ([6cd10dc](https://github.com/rbarcante/claude-conductor/commit/6cd10dcba468d1555d249c041b64169cae75dfb5))
* **implement:** Update section cross-references for git isolation ([0ea712f](https://github.com/rbarcante/claude-conductor/commit/0ea712f09ccc473b8ca53a1e33c4c4d29a21a9cd))
* **license:** Add Attribution section to README.md ([b960fd6](https://github.com/rbarcante/claude-conductor/commit/b960fd6a895e43d0b1a099290292577219f18e7b))
* **license:** Create CONTRIBUTING.md with license and attribution ([52e1096](https://github.com/rbarcante/claude-conductor/commit/52e10960ab52a792b29d002b84160414cecae027))
* **license:** Create NOTICE file for Apache 2.0 compliance ([a8c5fc9](https://github.com/rbarcante/claude-conductor/commit/a8c5fc9170ce56f020ff64c2326925207634e1e7))
* **patterns:** Reference dual-format standard in TEMPLATE.md ([50c6dec](https://github.com/rbarcante/claude-conductor/commit/50c6decf98c41cf92d9a173db5439a15ab956250))
* **skills:** Create skill-development.md comprehensive guide ([d08578e](https://github.com/rbarcante/claude-conductor/commit/d08578ea8534eaf76e50c7ac6d0e805b25c210c9))
* **snippets:** Add Java section to snippets index ([4a48b89](https://github.com/rbarcante/claude-conductor/commit/4a48b8930a5f0b5cf0af841eafcb7730614805bd))


### Code Refactoring

* **agents:** Remove 'conductor:' prefix from agent names ([c820de1](https://github.com/rbarcante/claude-conductor/commit/c820de195d1e52d8f376158365e77dfb3bb7a08c))
* **conductor:** Reduce setup.md token usage by 72% ([#16](https://github.com/rbarcante/claude-conductor/issues/16)) ([5644c31](https://github.com/rbarcante/claude-conductor/commit/5644c31b4237dd0dd11624db0035ecb851d1d871))
* Consolidate CLI context injection across command files ([#3](https://github.com/rbarcante/claude-conductor/issues/3)) ([eac5008](https://github.com/rbarcante/claude-conductor/commit/eac500899ca33354251424256a0682e84c2a7e78))
* **patterns:** Convert all code examples to language-neutral pseudocode ([1e8b159](https://github.com/rbarcante/claude-conductor/commit/1e8b15967e4fd5a0ce42439150d31dfba4f9b122))
* **skills:** Update all skill names to lowercase-with-hyphens format ([1b668f6](https://github.com/rbarcante/claude-conductor/commit/1b668f6f5fbe42dcf55f92c5bd4b0c7cfc5c4ed1))

## [1.1.0](https://github.com/rbarcante/claude-conductor/compare/v1.0.1...v1.1.0) (2026-02-06)


### Features

* **agents:** Add 5 specialist sub-agents for parallel code analysis ([812155c](https://github.com/rbarcante/claude-conductor/commit/812155cb1250d695fcbeddf93bbf48508f1d75ff))
  * code-quality-analyzer - Code quality and maintainability analysis
  * codebase-pattern-detector - Codebase architecture and pattern detection
  * git-history-analyst - Git history and change pattern analysis
  * security-scanner - Security vulnerability scanning
  * test-coverage-analyzer - Test coverage gap analysis
* **commands:** Add revert command for track implementation rollback ([812155c](https://github.com/rbarcante/claude-conductor/commit/812155cb1250d695fcbeddf93bbf48508f1d75ff))
* **commands:** Integrate specialist sub-agents into codeReview command for parallel analysis ([08d16bb](https://github.com/rbarcante/claude-conductor/commit/08d16bbba7fa2e0aeaaf0a75ac64a12f0eea3ff6))
* **commands:** Integrate specialist sub-agents into implement and setup commands ([8ac2681](https://github.com/rbarcante/claude-conductor/commit/8ac2681cb06f4e5bac9bca2313f26df342633a83))
* **conductor:** Reduce token usage by 74% across implement.md, newTrack.md, setup.md, and CLAUDE.md ([5644c31](https://github.com/rbarcante/claude-conductor/commit/5644c31b4237dd0dd11624db0035ecb851d1d871))
* **protocols:** Add pattern-resolution protocol for automatic pattern surfacing ([5644c31](https://github.com/rbarcante/claude-conductor/commit/5644c31b4237dd0dd11624db0035ecb851d1d871))
* **protocols:** Add skill-loading protocol for context-aware skill activation ([5644c31](https://github.com/rbarcante/claude-conductor/commit/5644c31b4237dd0dd11624db0035ecb851d1d871))
* **protocols:** Add verify-setup protocol for setup validation ([e430fca](https://github.com/rbarcante/claude-conductor/commit/e430fcaf2c4bd6202affa91b2153edd6f8bb1fb0))
* **skills:** Add conductor-methodology SKILL-SUMMARY for lightweight skill loading ([5644c31](https://github.com/rbarcante/claude-conductor/commit/5644c31b4237dd0dd11624db0035ecb851d1d871))
* **templates:** Add AskUserQuestion patterns template for JSON reference ([5644c31](https://github.com/rbarcante/claude-conductor/commit/5644c31b4237dd0dd11624db0035ecb851d1d871))
* **conductor:** Add project index and tracks registry ([5644c31](https://github.com/rbarcante/claude-conductor/commit/5644c31b4237dd0dd11624db0035ecb851d1d871))
...
* **agents:** Remove 'conductor:' prefix from agent names for simplified references ([c820de1](https://github.com/rbarcante/claude-conductor/commit/c820de195d1e52d8f376158365e77dfb3bb7a08c))
* **conductor:** Reduce setup.md token usage by 72% ([#16](https://github.com/rbarcante/claude-conductor/issues/16)) ([5644c31](https://github.com/rbarcante/claude-conductor/commit/5644c31b4237dd0dd11624db0035ecb851d1d871))
* **commands:** Condense implement.md from 684 to 348 lines (49% reduction) ([5644c31](https://github.com/rbarcante/claude-conductor/commit/5644c31b4237dd0dd11624db0035ecb851d1d871))
* **commands:** Condense newTrack.md from 544 to 176 lines (68% reduction) ([5644c31](https://github.com/rbarcante/claude-conductor/commit/5644c31b4237dd0dd11624db0035ecb851d1d871))
* **conductor:** Condense CLAUDE.md from 339 to 86 lines (75% reduction) ([5644c31](https://github.com/rbarcante/claude-conductor/commit/5644c31b4237dd0dd11624db0035ecb851d1d871))
